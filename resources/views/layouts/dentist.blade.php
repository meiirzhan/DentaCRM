...
<div class="container-fluid">
    ...
    <div class="d-flex vh-100">
                    ...
                    <ul class="nav nav-pills flex-column" id="pills-tab">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-main-tab" data-toggle="pill" href="#pills-main"
                               role="tab" aria-controls="pills-notes" aria-selected="true">Главная</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <ul class="nav nav-pills flex-column" id="pills-tab">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-main-tab" onclick="closeNav()" data-toggle="pill" href="#pills-main"
                       role="tab" aria-controls="pills-notes" aria-selected="true">Главная</a>
                </li>
                <li class="nav-item">
...
</div><div class="modal fade" id="modalAddProduct" tabindex="-1" role="dialog" aria-labelledby="modalAddProductLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
